...
const AnimatedSectionList = react_1.default.memo((props) => {
    ...
    if (!props.sectionList && props.listData) {
        return (react_1.default.createElement(react_native_1.FlatList, Object.assign({}, props, { data: props.listData, renderItem: (item) => (react_1.default.createElement(ItemList_1.ListItem, { item: item, defaultItemHeight: props.defaultItemHeight, expandItemHeight: props.expandItemHeight, duration: props.duration, onItemPress: props.onItemPress, itemStyle: props.listItemStyle, easing: props.easing, renderListItem: props.renderItem, renderExpandListItem: props.renderExpandListItem })) })));
    }
